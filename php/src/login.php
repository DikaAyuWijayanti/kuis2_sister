<!DOCTYPE html>
                        <html>
                            <head>
                                ...
                                <title>SELAMAT DATANG di SMANDA</title>
    ...
    <div class="container">
        <div class="login-box">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <span class="logo-font">GO&nbsp;</span>SMANDA
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <form class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <!--<a href="#!" class="forgot-password"><br> &nbsp;Forgot Password?</a>!-->
                        </div>
                        <div class="form-group">
                            <form action="loginProses.php" method="post">
                            <button class="btn btn-primary btn-block">LOGIN <form action="loginProses.php" method="post"></button>
                            <form action="loginProses.php" method="post">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="slider-feature-card">
                                    ...
                                    <h3 class="slider-title">Admin 1</h3>
                            ...
                            <div class="carousel-item">
                                <div class="slider-feature-card">
                                    ...
                                    <h3 class="slider-title">Admin 2</h3>
